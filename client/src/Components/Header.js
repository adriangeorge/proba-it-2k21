        ...
        <nav className='flex justify-between relative ml-5 space-x-4 '>
            ...
            <div className="px-3 bg-header-texture bg-contain bg-right-top bg-no-repeat max-h-36 relative ">
                ...
                <div className="hidden md:flex justify-center absolute top-0 right-0 pt-6 pr-3 md:gap-x-6 lg:gap-x-10 xl:gap-x-14">
                    ...
                    <Button text="Logare" btn_type="bg-primary text-white w-32 py-2 px-3" />

                    <Button text="Creeare Cont" btn_type="bg-primary text-white w-32 py-2 px-3" />

                    <Button text="Contact" btn_type="bg-primary text-white w-32 py-2 px-3" />
                ...
                <div className={(!mobileMenuActive ? "hidden " : "") + " md:hidden flex-col items-center absolute top-15 rounded-2xl right-0 pt-1 px-3 space-y-3 bg-primary text-white text-right "}>
                    <div>Logare</div>
                    <div>Creeare Cont</div>
                    <div>Contact</div>
                </div>
            </div>
